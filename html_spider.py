...
def get_jd_mean_page_list():
    ...
    lines = doc_main.xpath('//*[@id="categorys-2014"]/div[2]/div[1]/div/h3')
    for i, main_cat in enumerate(lines):
        sub_cat_list = main_cat.xpath('a/text()')
        sub_cat_url_list = main_cat.xpath('a/@href')
        result_dict[i + 1] = {"mean_cat": dict(zip(sub_cat_list, sub_cat_url_list)),
                              'sub_cat_list': []}
    with open('/Users/jilu/Downloads/jd_dropdown.html', 'r') as fr:
        content = fr.read()
...
#
# with open('/Users/jilu/Downloads/jd_cat.json', 'a') as fw:
#     fw.write(get_jd_mean_page_list())
# with open('/Users/jilu/Downloads/jd_cat.json', 'r') as fr:
#     jd_cat_dict = json.loads(fr.read())
...
def run():
    jd_cat_dict = get_jd_mean_page_list()
    ...
    with open('/Users/jilu/Downloads/jd_cat_brand_all.json', 'a') as fw:
